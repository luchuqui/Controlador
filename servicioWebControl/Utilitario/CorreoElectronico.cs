...
namespace ControlerAtm.Utilitario
{
    public class CorreoElectronico : NotificacionDao
    {
        ...
        {
            correo.From = new MailAddress("soporte_notificacion@servicio.com.ec");//Correo de origen
        ...
        public int enviar_notificacion(string mensajeEnviar, string titulo)
        {
            ...
            correo.Body = "<p><b><font color=blue>" + mensajeEnviar + 
                ...
                + "<p>No responda a este correo, contactese con soporte técnico o el administrador de aplicación l2ch copyrigth</p>";
            try
            {
                smtp.Send(correo);
                correo.Dispose();
