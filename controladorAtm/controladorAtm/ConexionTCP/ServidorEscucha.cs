...
namespace controladorAtm
{
    public class ServidorEscucha
    {
        ...
        private IPAddress IPlocal; /*Objeto para almacenar la direccion IP*/
        ...
        private Thread hiloServidor; /*Hilo maestro para atender las peticiones de los terminales*/
        private ArrayList terminalesConectadas; /*Almacenamiento de terminales conectadas*/
        private ArrayList atmsAutorizados; /*Almacenamiento para terminales autorizados*/
